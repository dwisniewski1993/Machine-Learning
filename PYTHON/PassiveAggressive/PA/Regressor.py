...
class PassiveAggressiveRegression:
    ...
    def grid_search(self):
        ...
        :return: None
        """
        classifier = GridSearchCV(PassiveAggressiveRegressor(), parameters, cv=5,
    ...
    def train_model(self):
        ...
        :return: None
        """
        self.model = PassiveAggressiveRegressor(**dict(self.grid_params)).fit(self.X_train, self.Y_train)
