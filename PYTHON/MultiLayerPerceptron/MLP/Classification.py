...
class MultiLayerPerceptronClassification:
    ...
    def grid_search(self):
        ...
        :return: None
        """
        classifier = GridSearchCV(neural_network.MLPClassifier(), parameters, cv=5)
    ...
    def train_model(self):
        ...
        :return: None
        """
        self.model = neural_network.MLPClassifier(**dict(self.grid_params)).fit(self.X_train, self.Y_train)
