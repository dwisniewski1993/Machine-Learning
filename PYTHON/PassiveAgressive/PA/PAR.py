...
class PARegressor:
    ...
    def __init__(self, trainfile):
        """
        PA Regression Constructor
        Loading and preparing data
        :param trainfile: Poznań flats data tsv path
        """
        log.getLogger().setLevel(log.INFO)
        log.info('Passive Aggressive Regressor')
    ...
    def output(self):
        ...
        :return: None
        """
        y_pred = self.par.predict(self.X_test)
    ...
    def grid_search(self):
        ...
        classifier = GridSearchCV(PassiveAggressiveRegressor(), hyperparam_grid, cv=5, iid=False,
    ...
    def train_model(self):
        ...
        :return: None
        """
        self.par = PassiveAggressiveRegressor(C=self.grided_params[0]).fit(self.X_train, self.Y_train)
